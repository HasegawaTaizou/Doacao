  ...
  <section id="settings-dashboard">
    ...
    <div class="settings__content">
      <div class="hospital-general-data">
        <img src="../../assets/img/hospital-profile-image.png" alt="Hospital Image" class="hospital-general-data__image">
        <h2 class="hospital-general-data__title">Hospital Notredame Intermédica</h2>
        <div class="hospital-general-data__cnpj-container">
          <label for="" class="cnpj__label">CNPJ:</label>
          <input type="text" class="cnpj__input" disabled>
        </div>
      </div>
      ...
      <div class="hospital-donation-site-data">
        ...
        <div class="hospital-donation-site-data__site-container">
          ...
          <textarea name="" id="" cols="30" rows="10" class="site__textarea" disabled></textarea>
        </div>
        <div class="hospital-donation-site-data__other-site-container">
          <label for="" class="other-site__label">Local 2:</label>
          <textarea name="" id="" cols="30" rows="10" class="other-site__textarea" disabled></textarea>
        </div>
      </div>
      <div class="hospital-actions">
        <button class="action__redefine-password-container">
          <span class="redefine-password__text">Redefinir senha</span>
          <img src="../../assets/img/redefine-password-icon.png" alt="Redefine Password Icon" class="redefine-password__icon">
        </button>
        <button class="edit-profile-container">
          <span class="edit-profile__text">Editar perfil</span>
          <img src="../../assets/img/edit-profile-icon.png" alt="Edit Profile Icon" class="edit-profile__icon">
        </button>
      </div>
    </div>
  </section>
